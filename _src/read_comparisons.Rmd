...
#I wll use a scatter plot to plot the most and least abundant gene from each data set and compare between the two data sets.

```{r}
esc_expr_pe_tibble_t %>% 
  ggplot() + 
  aes( x =  sample_id,  y = 'ENSMUSG00000007892')  +
  geom_point(size = 2) +
  theme_pubclean()
