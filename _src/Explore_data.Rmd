...
esc_expr_r1_tibble_t %>% 
  ...
  aes( x = 'ENSMUSG00000000903' ) + # aesthetics determine which variable is being plotted and how it is being used. you can use column names here. 
  geom_histogram( bins = 1000, col = "blue", alpha = 0.5, stat = "count") + # which plot to show
  theme_pubclean() 
...
esc_expr_r1_tibble_t  %>% 
  ggplot() + # call ggplot to make the plot!
  aes( x = 'ENSMUSG00000000295') + # aesthetics determine which variable is being plotted and how it is being used. you can use column names here. 
  geom_density(  col = "blue", alpha = 0.5, adjust = 0.5) + # which plot to show
  geom_density( aes( x = 'ENSMUSG00000000295'), col = "red",  alpha = 0.1, adjust =0.5)+
  theme_pubclean() 
